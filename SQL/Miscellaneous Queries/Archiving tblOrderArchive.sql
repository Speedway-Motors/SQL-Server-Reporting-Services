 ...
 ************************************************************************/
 ...
 select datepart("yyyy",dtOrderDate) 'Year', count(*) 'OrdCnt'
 from [SMI Reporting].dbo.tblOrder
 group by datepart("yyyy",dtOrderDate)
 order by datepart("yyyy",dtOrderDate) desc
/*
Year	OrdCnt
2013	474030
2012	476243
...
-- Make sure fields in both table are identical 
 select top 10 * from [SMIArchive].dbo.tblOrderArchive
 select top 10 * from [SMI Reporting].dbo.tblOrder
-- if any are missing add new columns to archive table.  Make sure names and data types are EXACT matches
...
where ixDate between 16011 and 16040   --15737   

select count(*) from tblSnapshotSKUArchive -- 0
where ixDate between 15707 and 16071   
...
16041 and 16071   2,661,467
*/

-- 1st QTR
SELECT COUNT(*) from tblSnapshotSKUArchive where ixDate between 15707 and 16041  -- 8,331,906   
                                                                                 -- 8,331,906 in tblSnapshotSKU
