...
HAVING /*Match_Percent*/    (100 * COUNT(c2.COLUMN_NAME) /*Matching_Column_Count*/) / MIN(ColCountsByTable.Column_Count) /*Column_Count*/ >= 50       --Require atleast 50% of the columns to match
