...
-- Do a replace/find function and replace the previous date part with the current date part (i.e. find 9/30/ replace with 10/31/ --- 167 occurrences 

/********************************************************************************************
   STEP 2 - POPULATE THE TABLE WITH EVERY CUSTOMER & THEIR ORDER HISTORY BY 12 MONTH PERIODS
                        approx 0:34 sec runtime (USE LNK-SQL-LIVE-1) 
********************************************************************************************/     

/*
       
insert into [SMITemp].dbo.ASC_CustomerOrderHistory    
select C.ixCustomer, FO.FirstOrder, -- 2,072,882
...
-- into [SMITemp].dbo.ASC_CustomerOrderHistory       
    ...
    left JOIN (select ixCustomer,
             --   min(datepart("yyyy",dtOrderDate)) [FirstOrder],
                (case when min(dtOrderDate) >  DATEADD(MM, -12, '9/30/18') 
                       and min(dtOrderDate) <= '9/30/18'                   then '12M'
                when min(dtOrderDate) >  DATEADD(MM, -24, '9/30/18') 
                       and min(dtOrderDate) <= DATEADD(MM, -12, '9/30/18')  then '24M'
                when min(dtOrderDate) >  DATEADD(MM, -36, '9/30/18') 
                       and min(dtOrderDate) <= DATEADD(MM, -24, '9/30/18')  then '36M'
                when min(dtOrderDate) >  DATEADD(MM, -48, '9/30/18') 
                       and min(dtOrderDate) <= DATEADD(MM, -36, '9/30/18')  then '48M'
                when min(dtOrderDate) >  DATEADD(MM, -60, '9/30/18') 
                       and min(dtOrderDate) <= DATEADD(MM, -48, '9/30/18')  then '60M'
                when min(dtOrderDate) >  DATEADD(MM, -72, '9/30/18') 
                       and min(dtOrderDate) <= DATEADD(MM, -60, '9/30/18')  then '72M'
                when min(dtOrderDate) >  DATEADD(MM, -84, '9/30/18') 
                       and min(dtOrderDate) <= DATEADD(MM, -72, '9/30/18')  then '84M'
                when min(dtOrderDate) >  DATEADD(MM, -96, '9/30/18') 
                       and min(dtOrderDate) <= DATEADD(MM, -84, '9/30/18')  then '96M'
                when min(dtOrderDate) >  DATEADD(MM, -108, '9/30/18') 
                       and min(dtOrderDate) <= DATEADD(MM, -96, '9/30/18')  then '108M'
                when min(dtOrderDate) >  DATEADD(MM, -120, '9/30/18') 
                       and min(dtOrderDate) <= DATEADD(MM, -108, '9/30/18')  then '120M'                                                                                                                                                                                        
                when min(dtOrderDate) >  DATEADD(MM, -132, '9/30/18') 
                       and min(dtOrderDate) <= DATEADD(MM, -120, '9/30/18')  then '132M'   
                when min(dtOrderDate) >  DATEADD(MM, -144, '9/30/18') 
                       and min(dtOrderDate) <= DATEADD(MM, -132, '9/30/18')  then '144M' 
                     else '145M+'               
                     end) [FirstOrder]
    ...
    left join (select ixCustomer,
               ...
               from tblOrder
               where dtOrderDate >  DATEADD(MM, -12, '9/30/18')  -- 1 year ago
                 and dtOrderDate <= '9/30/18'                   -- today
    ...
    left join (select ixCustomer,
               ...
               from tblOrder
               where dtOrderDate >  DATEADD(MM, -24, '9/30/18')  -- 2 years ago
                 and dtOrderDate <= DATEADD(MM, -12, '9/30/18')  -- 1 years ago                 
                 and sOrderStatus = 'Shipped' and sOrderType <> 'Internal' -- and sOrderChannel <> 'INTERNAL'
               group by ixCustomer 
    ...
    left join (select ixCustomer,
               ...
               from tblOrder
               where dtOrderDate >  DATEADD(MM, -36, '9/30/18')  -- 3 years ago
                 and dtOrderDate <= DATEADD(MM, -24, '9/30/18')  -- 2 years ago                 
                 and sOrderStatus = 'Shipped' and sOrderType <> 'Internal' -- and sOrderChannel <> 'INTERNAL'
               group by ixCustomer 
    ...
    left join (select ixCustomer,
               ...
               where dtOrderDate >  DATEADD(MM, -48, '9/30/18')  -- 4 years ago
                 and dtOrderDate <= DATEADD(MM, -36, '9/30/18')  -- 3 years ago                 
                 and sOrderStatus = 'Shipped' and sOrderType <> 'Internal' -- and sOrderChannel <> 'INTERNAL'
               group by ixCustomer 
    ...
    left join (select ixCustomer,
               ...
               from vwOrderAllHistory
               where dtOrderDate >  DATEADD(MM, -60, '9/30/18')  -- 5 years ago
                 and dtOrderDate <= DATEADD(MM, -48, '9/30/18')  -- 4 years ago                 
                 and sOrderStatus = 'Shipped' and sOrderType <> 'Internal' -- and sOrderChannel <> 'INTERNAL'
               group by ixCustomer 
    ...
    left join (select ixCustomer,
               ...
               from vwOrderAllHistory
               where dtOrderDate >  DATEADD(MM, -72, '9/30/18')  -- 6 years ago
                 and dtOrderDate <= DATEADD(MM, -60, '9/30/18')  -- 5 years ago                 
                 and sOrderStatus = 'Shipped' and sOrderType <> 'Internal' -- and sOrderChannel <> 'INTERNAL'
               group by ixCustomer 
    ...
    left join (select ixCustomer,
               ...
               from vwOrderAllHistory
               where dtOrderDate >  DATEADD(MM, -84, '9/30/18')  -- 7 years ago
                 and dtOrderDate <= DATEADD(MM, -72, '9/30/18')  -- 6 years ago                 
                 and sOrderStatus = 'Shipped' and sOrderType <> 'Internal' -- and sOrderChannel <> 'INTERNAL'
               group by ixCustomer 
    ...
    left join (select ixCustomer,
               ...
               from vwOrderAllHistory
               where dtOrderDate >  DATEADD(MM, -96, '9/30/18')  -- 8 years ago
                 and dtOrderDate <= DATEADD(MM, -84, '9/30/18')  -- 7 years ago                 
                 and sOrderStatus = 'Shipped' and sOrderType <> 'Internal' -- and sOrderChannel <> 'INTERNAL'
               group by ixCustomer 
    ...
    left join (select ixCustomer,
               ...
               from vwOrderAllHistory
               where dtOrderDate >  DATEADD(MM, -108, '9/30/18')  -- 9 years ago
                 and dtOrderDate <= DATEADD(MM, -96, '9/30/18')  -- 8 years ago                 
                 and sOrderStatus = 'Shipped' and sOrderType <> 'Internal' -- and sOrderChannel <> 'INTERNAL'
               group by ixCustomer 
    ...
    left join (select ixCustomer,
               ...
               from vwOrderAllHistory
               where dtOrderDate >  DATEADD(MM, -120, '9/30/18')  -- 10 years ago
                 and dtOrderDate <= DATEADD(MM, -108, '9/30/18')  -- 9 years ago                 
                 and sOrderStatus = 'Shipped' and sOrderType <> 'Internal' -- and sOrderChannel <> 'INTERNAL'
               group by ixCustomer 
    ...
    left join (select ixCustomer,
               ...
               from vwOrderAllHistory
               where dtOrderDate >  DATEADD(MM, -132, '9/30/18')  -- 11 years ago
                 and dtOrderDate <= DATEADD(MM, -120, '9/30/18')  -- 10 years ago                 
                 and sOrderStatus = 'Shipped' and sOrderType <> 'Internal' -- and sOrderChannel <> 'INTERNAL'
               group by ixCustomer 
    ...
    left join (select ixCustomer,
               ...
               from vwOrderAllHistory
               where dtOrderDate >  DATEADD(MM, -144, '9/30/18')  -- 12 years ago
                 and dtOrderDate <= DATEADD(MM, -132, '9/30/18')  -- 11 years ago                 
                 and sOrderStatus = 'Shipped' and sOrderType <> 'Internal' -- and sOrderChannel <> 'INTERNAL'
               group by ixCustomer 
    ...
    left join (select ixCustomer,
               ...
               from vwOrderAllHistory
               where dtOrderDate >  DATEADD(MM, -145, '9/30/18')  -- 12 years ago
                 and dtOrderDate <= DATEADD(MM, -144, '9/30/18')  -- 11 years ago                 
                 and sOrderStatus = 'Shipped' and sOrderType <> 'Internal' -- and sOrderChannel <> 'INTERNAL'
               group by ixCustomer 
...
SELECT
    ...
    left join (select ixCustomer
               ...
               from tblOrder O  
               where O.dtOrderDate BETWEEN DATEADD(MM, -12, '9/30/18') AND '9/30/18'
    ...
    left join (select ixCustomer
                    ...
                    , COUNT(DISTINCT O.ixOrder) AS OrderCnt  
               from tblOrder O  
               where O.dtOrderDate BETWEEN DATEADD(MM, -72, '9/30/18') AND '9/30/18'
                 AND O.sOrderType <> 'Internal' 
                 AND O.sOrderStatus = 'Shipped' 
                 AND O.ixOrder NOT LIKE '%-%' 
                 AND O.mMerchandise > 1 
...
SELECT
    ...
    left join (select ixCustomer
                    ...
                    , COUNT(DISTINCT O.ixOrder) AS OrderCnt  
               from tblOrder O  
               where O.dtOrderDate BETWEEN DATEADD(MM, -12, '9/30/17') AND '9/30/17'
                 AND O.sOrderType <> 'Internal' 
                 AND O.sOrderStatus = 'Shipped' 
                 AND O.ixOrder NOT LIKE '%-%' 
                 AND O.mMerchandise > 1 
    ...
    left join (select ixCustomer
                    ...
                    , COUNT(DISTINCT O.ixOrder) AS OrderCnt  
               from tblOrder O  
               where O.dtOrderDate BETWEEN DATEADD(MM, -72, '9/30/17') AND '9/30/17' 
                 AND O.sOrderType <> 'Internal' 
                 AND O.sOrderStatus = 'Shipped' 
                 AND O.ixOrder NOT LIKE '%-%' 
                 AND O.mMerchandise > 1 
...
SELECT
    ...
    left join (select ixCustomer
                    ...
                    , COUNT(DISTINCT O.ixOrder) AS OrderCnt  
               from tblOrder O  
               where O.dtOrderDate BETWEEN DATEADD(MM, -12, '9/30/16') AND '9/30/16'
                 AND O.sOrderType <> 'Internal' 
                 AND O.sOrderStatus = 'Shipped' 
                 AND O.ixOrder NOT LIKE '%-%' 
                 AND O.mMerchandise > 1 
    ...
    left join (select ixCustomer
                    ...
                    , COUNT(DISTINCT O.ixOrder) AS OrderCnt  
               from tblOrder O  
               where O.dtOrderDate BETWEEN DATEADD(MM, -72, '9/30/16') AND '9/30/16' 
                 AND O.sOrderType <> 'Internal' 
                 AND O.sOrderStatus = 'Shipped' 
                 AND O.ixOrder NOT LIKE '%-%' 
                 AND O.mMerchandise > 1 
...
SELECT
    ...
    left join (select ixCustomer
                    ...
                    , COUNT(DISTINCT O.ixOrder) AS OrderCnt  
               from tblOrder O  
               where O.dtOrderDate BETWEEN DATEADD(MM, -12, '9/30/15') AND '9/30/15'
                 AND O.sOrderType <> 'Internal' 
                 AND O.sOrderStatus = 'Shipped' 
                 AND O.ixOrder NOT LIKE '%-%' 
                 AND O.mMerchandise > 1 
    ...
    left join (select ixCustomer
                    ...
                    , COUNT(DISTINCT O.ixOrder) AS OrderCnt  
               from tblOrder O  
               where O.dtOrderDate BETWEEN DATEADD(MM, -72, '9/30/15') AND '9/30/15'
                 AND O.sOrderType <> 'Internal' 
                 AND O.sOrderStatus = 'Shipped' 
                 AND O.ixOrder NOT LIKE '%-%' 
                 AND O.mMerchandise > 1 
...
SELECT
    ...
    left join (select ixCustomer
                    ...
                    , COUNT(DISTINCT O.ixOrder) AS OrderCnt  
               from tblOrder O  
               where O.dtOrderDate BETWEEN DATEADD(MM, -12, '9/30/14') AND '9/30/14'
                 AND O.sOrderType <> 'Internal' 
                 AND O.sOrderStatus = 'Shipped' 
                 AND O.ixOrder NOT LIKE '%-%' 
                 AND O.mMerchandise > 1 
    ...
    left join (select ixCustomer
               ...
               where O.dtOrderDate BETWEEN DATEADD(MM, -72, '9/30/14') AND '9/30/14'
                 AND O.sOrderType <> 'Internal' 
                 AND O.sOrderStatus = 'Shipped' 
                 AND O.ixOrder NOT LIKE '%-%' 
                 AND O.mMerchandise > 1 
...
SELECT
    ...
    left join (select ixCustomer
                    ...
                    , COUNT(DISTINCT O.ixOrder) AS OrderCnt  
               from tblOrder O  
               where O.dtOrderDate BETWEEN DATEADD(MM, -12, '9/30/13') AND '9/30/13'
                 AND O.sOrderType <> 'Internal' 
                 AND O.sOrderStatus = 'Shipped' 
                 AND O.ixOrder NOT LIKE '%-%' 
                 AND O.mMerchandise > 1 
    ...
    left join (select ixCustomer
                    ...
                    , COUNT(DISTINCT O.ixOrder) AS OrderCnt  
               from vwOrderAllHistory O  
               where O.dtOrderDate BETWEEN DATEADD(MM, -72, '9/30/13') AND '9/30/13'
                 AND O.sOrderType <> 'Internal' 
                 AND O.sOrderStatus = 'Shipped' 
                 AND O.ixOrder NOT LIKE '%-%' 
                 AND O.mMerchandise > 1 
...
/**** 12M NAME FLOW ****/
    ...
    left join (select ixCustomer
                    ...
                    , COUNT(DISTINCT O.ixOrder) AS OrderCnt  
               from tblOrder O  
               where O.dtOrderDate BETWEEN DATEADD(MM, -24, '9/30/18') AND DATEADD(MM, -12, '9/30/18')
                 AND O.sOrderType <> 'Internal' 
                 AND O.sOrderStatus = 'Shipped' 
                 AND O.ixOrder NOT LIKE '%-%' 
                 AND O.mMerchandise > 1 
     ...
     left join (select ixCustomer
                    ...
                    , COUNT(DISTINCT O.ixOrder) AS OrderCnt  
               from tblOrder O  
               where O.dtOrderDate BETWEEN DATEADD(MM, -72, '9/30/18') AND DATEADD(MM, -12, '9/30/18')
                 AND O.sOrderType <> 'Internal' 
                 AND O.sOrderStatus = 'Shipped' 
                 AND O.ixOrder NOT LIKE '%-%' 
                 AND O.mMerchandise > 1 
...
/**** 24M NAME FLOW ****/
    ...
    left join (select ixCustomer
                    ...
                    , COUNT(DISTINCT O.ixOrder) AS OrderCnt  
               from tblOrder O  
               where O.dtOrderDate BETWEEN DATEADD(MM, -24, '9/30/17' ) AND DATEADD(MM, -12, '9/30/17' )
                 AND O.sOrderType <> 'Internal' 
                 AND O.sOrderStatus = 'Shipped' 
                 AND O.ixOrder NOT LIKE '%-%' 
                 AND O.mMerchandise > 1 
     ...
     left join (select ixCustomer
                    ...
                    , COUNT(DISTINCT O.ixOrder) AS OrderCnt  
               from tblOrder O  
               where O.dtOrderDate BETWEEN DATEADD(MM, -72, '9/30/17') AND DATEADD(MM, -12, '9/30/17')
                 AND O.sOrderType <> 'Internal' 
                 AND O.sOrderStatus = 'Shipped' 
                 AND O.ixOrder NOT LIKE '%-%' 
                 AND O.mMerchandise > 1 
...
/**** 36M NAME FLOW ****/
    ...
    left join (select ixCustomer
                    ...
                    , COUNT(DISTINCT O.ixOrder) AS OrderCnt  
               from tblOrder O  
               where O.dtOrderDate BETWEEN DATEADD(MM, -24, '9/30/16' ) AND DATEADD(MM, -12, '9/30/16' )
                 AND O.sOrderType <> 'Internal' 
                 AND O.sOrderStatus = 'Shipped' 
                 AND O.ixOrder NOT LIKE '%-%' 
                 AND O.mMerchandise > 1 
     ...
     left join (select ixCustomer
                    ...
                    , COUNT(DISTINCT O.ixOrder) AS OrderCnt  
               from tblOrder O  
               where O.dtOrderDate BETWEEN DATEADD(MM, -72, '9/30/16') AND DATEADD(MM, -12, '9/30/16')
                 AND O.sOrderType <> 'Internal' 
                 AND O.sOrderStatus = 'Shipped' 
                 AND O.ixOrder NOT LIKE '%-%' 
                 AND O.mMerchandise > 1 
...
/**** 48M NAME FLOW ****/
    ...
    left join (select ixCustomer
                    ...
                    , COUNT(DISTINCT O.ixOrder) AS OrderCnt  
               from tblOrder O  
               where O.dtOrderDate BETWEEN DATEADD(MM, -24, '9/30/15' ) AND DATEADD(MM, -12, '9/30/15' )
                 AND O.sOrderType <> 'Internal' 
                 AND O.sOrderStatus = 'Shipped' 
                 AND O.ixOrder NOT LIKE '%-%' 
                 AND O.mMerchandise > 1 
     ...
     left join (select ixCustomer
                    ...
                    , COUNT(DISTINCT O.ixOrder) AS OrderCnt  
               from tblOrder O  
               where O.dtOrderDate BETWEEN DATEADD(MM, -72, '9/30/15') AND DATEADD(MM, -12, '9/30/15')
                 AND O.sOrderType <> 'Internal' 
                 AND O.sOrderStatus = 'Shipped' 
                 AND O.ixOrder NOT LIKE '%-%' 
                 AND O.mMerchandise > 1 
...
/**** 60M NAME FLOW ****/
    ...
    left join (select ixCustomer
                    ...
                    , COUNT(DISTINCT O.ixOrder) AS OrderCnt  
               from tblOrder O  
               where O.dtOrderDate BETWEEN DATEADD(MM, -24, '9/30/14' ) AND DATEADD(MM, -12, '9/30/14' )
                 AND O.sOrderType <> 'Internal' 
                 AND O.sOrderStatus = 'Shipped' 
                 AND O.ixOrder NOT LIKE '%-%' 
                 AND O.mMerchandise > 1 
     ...
     left join (select ixCustomer
                    ...
                    , COUNT(DISTINCT O.ixOrder) AS OrderCnt  
               from vwOrderAllHistory O  
               where O.dtOrderDate BETWEEN DATEADD(MM, -72, '9/30/14') AND DATEADD(MM, -12, '9/30/14')
                 AND O.sOrderType <> 'Internal' 
                 AND O.sOrderStatus = 'Shipped' 
                 AND O.ixOrder NOT LIKE '%-%' 
                 AND O.mMerchandise > 1 
