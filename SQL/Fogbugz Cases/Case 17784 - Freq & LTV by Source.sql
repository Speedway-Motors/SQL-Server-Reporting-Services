...
where C.dtAccountCreateDate >= '09/10/2010'
...
select (Case
            ...
            when C.ixSourceCode in ('35012','35480','33842','33843','31743','31744')                                    then 'Good Guys'            
            when C.ixSourceCode in ('357502','349502','358518','363518','351518','360518','353518','364518','347576','343576',
                                    '346576','339542','335542','334542','324542','318512','325512','332512','346574')        then 'ILSS'             
            when C.ixSourceCode in ('35884','31536')                            then 'IMCA'
            when C.ixSourceCode in ('338520','335520','36380','362520','33339')                                    then 'POWRi'                         
            ...
            when C.ixSourceCode in ('35885','33771','31537')                    then 'Wissota' 
...
from tblSourceCode
where ixSourceCode in ('35880','347500',
...
from tblCustomer C
    ...
    join (select O.ixCustomer, COUNT(O.ixOrder) OrdCnt
          from tblOrder O
          where O.dtShippedDate >=  '09/10/2010'
            and O.sOrderStatus = 'Shipped'
            and O.sOrderType <> 'Internal'
            and O.sOrderChannel <> 'INTERNAL'
            and O.mMerchandise > 0 
...
from tblCustomer C
    left join tblSourceCode SC on C.ixSourceCode = SC.ixSourceCode
    left join tblSourceCodeType SCT on SC.sSourceCodeType = SCT.ixSourceCodeType
where C.dtAccountCreateDate >= '09/10/2012'  
    and C.flgDeletedFromSOP = 0
...
=========   =============== =======
WEB-H	    Web House	    72304
OTHER	    Other	        35416
FLY-E	    Flyer Email	    18308
CAT-E	    Catalog @ Event	5225
FLY-P	    Flyer Prospect	4172
CAT-H	    Catalog House	4150
AD-PRINT	Print Ad	    3455
NULL	    NULL	        1407
CAT-R	    Catalog Request	1313
CAT-P	    Catalog Prospect 878
WEB-P	    Web Prospect	99
UNKNOWN	    NULL	        7
PIP-H	    Package Insert	6
FLY-H	    Flyer House	    1
*/
