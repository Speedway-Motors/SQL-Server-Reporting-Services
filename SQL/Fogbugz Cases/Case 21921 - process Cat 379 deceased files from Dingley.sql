-- Case 21921 - process Cat 379 deceased files from Dingley
    -- code copied from 21744
/*
...
375	'14 LS STREET	2014-04-14  03-
...
select count(*) from [SMI Reporting].dbo.tblCustomer -- 374
...
-- DROP TABLE PJC_21921_DeceasedCat379_FD03122014
select count(ixCustomer) CustCnt, 
    count(distinct ixCustomer) DstnctCustCnt
from PJC_21921_DeceasedCat379_FD03122014
...
from  PJC_21921_DeceasedCat379_FD03122014 DC
...
select O.ixCustomer, max(O.dtOrderDate) LastOrd
    from [SMI Reporting].dbo.tblOrder O
    join PJC_21921_DeceasedCat379_FD03122014 DC on O.ixCustomer = DC.ixCustomer
...
DELETE 
from PJC_21190_DeceasedCat373_FD01102014
where ixCustomer in (select ixCustomer from PJC_21921_DeceasedCat379_FD03122014)
