-- Case 21667 - process Cat 374 deceased files from Dingley
    -- code copied from 21390
/*
...
select count(*) from [SMI Reporting].dbo.tblCustomer -- 365
...
-- DROP TABLE PJC_21667_DeceasedCat374_FD02202014
select count(ixCustomer) CustCnt, 
    count(distinct ixCustomer) DstnctCustCnt
from PJC_21667_DeceasedCat374_FD02202014
...
from PJC_21667_DeceasedCat374_FD02202014 DC
...
select O.ixCustomer, max(O.dtOrderDate) LastOrd
    from [SMI Reporting].dbo.tblOrder O
    join PJC_21667_DeceasedCat374_FD02202014 DC on O.ixCustomer = DC.ixCustomer
...
DELETE 
from PJC_21190_DeceasedCat373_FD01102014
where ixCustomer in (select ixCustomer from PJC_21667_DeceasedCat374_FD02202014)
