-- Case 21390 - process Cat 378 deceased files from Dingley
    -- code copied from 21190
/*
...
-- DROP TABLE PJC_21390_DeceasedCat378_FD01302014
select count(ixCustomer) CustCnt, 
    count(distinct ixCustomer) DstnctCustCnt
from PJC_21390_DeceasedCat378_FD01302014
...
from PJC_21390_DeceasedCat378_FD01302014 DC
...
select O.ixCustomer, max(O.dtOrderDate) LastOrd
    from [SMI Reporting].dbo.tblOrder O
    join PJC_21390_DeceasedCat378_FD01302014 DC on O.ixCustomer = DC.ixCustomer
...
DELETE 
from PJC_21190_DeceasedCat373_FD01102014
where ixCustomer in (select ixCustomer from PJC_21390_DeceasedCat378_FD01302014)
