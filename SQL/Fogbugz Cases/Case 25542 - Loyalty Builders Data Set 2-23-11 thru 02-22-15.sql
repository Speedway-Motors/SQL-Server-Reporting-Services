 /* Case 25542 - Loyalty Builders Data Set 2-23-11 thru 02-22-15 */
 
 /********************************************************************************************
    SQL based on Case 25358
...
-- ALTER vwLBSampleTransactions on DWSTAGING1. Replication will apply the change to DW1 a few seconds later
    ...
    select COUNT(*) from vwLBSampleTransactions -- 4,249,977
...
FILE #1 - transaction file data 
    file name: SMI - Transactions 02022011 to 02012015
    records:     4.1M - 4.5M
    runtime:     60 sec 
****************************************************/
-- change SQL output to 
    select * from vwLBSampleTransactions -- 4,249,977 rows   @60 sec
                                    
                                    
/****************************************************  
FILE #2 - SKU file 
    file name: SMI - SKUs 02022011 to 02012015
    records:     48K - 57K records (^ about 1K/month)
    runtime:     10 - 30 sec    
****************************************************/
    select --56,659 records @18 sec 
	    SKU.ixSKU as 'itemid',      
...
FILE #3 - PRODUCTS w/ advanced market info 
    file name: SMI - SKU - Additional Markets File 02022011 to 02012015
    records:   165K - 176K
    runtime:   20-30 sec
 ****************************************************/
    -- STEP 1 of 3
        -- !! RUN IN TOAD from the TNG(live) db
                ...
                SELECT ixSOPSKU as 'ixSKU', -- 332,360 Rows
    ...
    -- STEP 3 of 3  create output for LB file               
            select -- 174,351 records  @20 secs
...
FILE #4 - CUSTOMER file 
    file name:   SMI - Customers 02022011 to 02012015
    records:     457K - 472K
    runtime:     20-40 sec  
 ****************************************************/
    select -- 471,720 records
...
FILE #5 - catalogs mailed to each cust & the corresponding type of catalog 
    file name:          SMI - Customer - Catalogs Mailed File 02022011 to 02012015
    approx storage(MB): 211 - 260
    approx records:     7.6M - 9.3M
    approx runtime:     1 - 3 mins
****************************************************/
    select -- 9,370,389  records      
    ...
    where
	    co.sType='OFFER'
	    and co.dtActiveStartDate between '02/23/2011' and '02/22/2015'     
...
FILE #6 - SKUs & applications 
    ...
    file name:          SMI - SKUs and Applications 02022011 to 02012015.txt
...
5   7.6M - 9.3M      211 - 262  SMI - Customer - Catalogs Mailed <MM-DD-YYYY> to <MM-DD-YYYY>.txt   Y       Y       Y     
6       63K          2.2 - 2.3  SMI - SKUs and Applications <MM-DD-YYYY> to <MM-DD-YYYY>.txt        Y       Y       Y
   ...
   naming convention = "SMI - dataset  <MM-DD-YYYY> to <MM-DD-YYYY>.zip" <-- or .7z
*/    
