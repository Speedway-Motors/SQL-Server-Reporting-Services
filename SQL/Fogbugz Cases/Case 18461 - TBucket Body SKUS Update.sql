...
/* This query is for all sales on items from 01/01/2013 to YTD */
...
LEFT JOIN 
         (
           ...
           WHERE OL.flgLineStatus = 'Shipped'
             and OL.dtShippedDate BETWEEN '01/01/2013' AND GETDATE()
...
/* This query is for all sales on items from 01/01/2012 to 12/31/2012 */
