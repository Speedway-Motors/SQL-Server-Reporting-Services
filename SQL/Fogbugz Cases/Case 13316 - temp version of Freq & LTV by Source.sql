...
where C.dtAccountCreateDate >= '04/11/2009'
...
from tblCustomer C
    ...
    join (select O.ixCustomer, COUNT(O.ixOrder) OrdCnt
          from tblOrder O
          where O.dtShippedDate >=  '04/11/2009'
            and O.sOrderStatus = 'Shipped'
            and O.sOrderType <> 'Internal'
            and O.sOrderChannel <> 'INTERNAL'
            and O.mMerchandise > 0 
...
/*    
Good Guys - 33842,33843,31743,31744
IMCA - 31536
Wissota (I just added this one) - 31537
*/
