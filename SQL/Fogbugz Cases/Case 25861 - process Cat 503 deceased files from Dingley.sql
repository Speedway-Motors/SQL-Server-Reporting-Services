 -- Case 25822 - process Cat 404 deceased files from Dingley
    -- code copied from Case 25514
...
where dtStartDate >= '03/30/2015'
order by dtStartDate

-- DECEASED are marked CATEGORY 4E !!!
PJC_25822_DeceasedCat404_FD03252015

-- ALTERNATE WAY TO IMPORT DECEASED FILE
select ixCustomer 
into [SMITemp].dbo.PJC_25822_DeceasedCat404_FD03252015
from tblCustomer
...
-- DROP TABLE PJC_25822_DeceasedCat404_FD03252015
select count(ixCustomer) CustCnt, 
    count(distinct ixCustomer) DstnctCustCnt
from [SMITemp].dbo.PJC_25822_DeceasedCat404_FD03252015
-- CustCnt    DstnctCustCnt
-- 49           49

-- Customer Count - Flagged DECEASED
select count(*) from [SMI Reporting].dbo.tblCustomer -- 487
...
from  [SMITemp].dbo.PJC_25822_DeceasedCat404_FD03252015 DC
...
-- load customers from above query into a txt file 404Deceased.txt
-- in SOP Reporting menu execute <10> Load Deceased Customer List  
-- 21 in file to load into SOP 
...
order by dtDateLastSOPUpdate
    ...
    select O.ixCustomer, C.sMailingStatus, max(O.dtOrderDate) LastOrd
        ...
        join [SMITemp].dbo.PJC_25822_DeceasedCat404_FD03252015 DC on O.ixCustomer = DC.ixCustomer
    ...
    450095	    0	            2015-03-21
    951838	    0	            2015-03-05
    2353447	    8	            2015-02-27
    2404447	    8	            2015-02-26
    203196	    8	            2015-01-21
*/
