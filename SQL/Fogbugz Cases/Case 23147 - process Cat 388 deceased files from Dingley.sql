-- Case 23147 - process Cat 388 deceased files from Dingley
    -- code copied from Case 23003
...
PJC_23147_DeceasedCat388_FD06252014

-- DROP TABLE PJC_23147_DeceasedCat388_FD06252014
select count(ixCustomer) CustCnt, 
    count(distinct ixCustomer) DstnctCustCnt
from PJC_23147_DeceasedCat388_FD06252014
...
from  PJC_23147_DeceasedCat388_FD06252014 DC
...
-- load customers from above query into a txt file <388Deceased.txt>
...
select O.ixCustomer, max(O.dtOrderDate) LastOrd
    from [SMI Reporting].dbo.tblOrder O
    join PJC_23147_DeceasedCat388_FD06252014 DC on O.ixCustomer = DC.ixCustomer
