-- Case 25011 - process Cat 391 deceased files from Dingley
    -- code copied from Case 24153
...
PJC_25011_DeceasedCat391_FD10232014

-- ALTERNATE WAY TO IMPORT DECEASED FILE
select ixCustomer 
into [SMITemp].dbo.PJC_25011_DeceasedCat391_FD10232014
from tblCustomer
...
-- DROP TABLE PJC_25011_DeceasedCat391_FD10232014
select count(ixCustomer) CustCnt, 
    count(distinct ixCustomer) DstnctCustCnt
from [SMITemp].dbo.PJC_25011_DeceasedCat391_FD10232014
-- CustCnt    DstnctCustCnt
-- 65           65

-- Customer Count - Flagged DECEASED
select count(*) from [SMI Reporting].dbo.tblCustomer -- 403
...
from  [SMITemp].dbo.PJC_25011_DeceasedCat391_FD10232014 DC
...
order by dtDateLastSOPUpdate
    ...
    select O.ixCustomer, C.sMailingStatus, max(O.dtOrderDate) LastOrd
        ...
        join [SMITemp].dbo.PJC_25011_DeceasedCat391_FD10232014 DC on O.ixCustomer = DC.ixCustomer
