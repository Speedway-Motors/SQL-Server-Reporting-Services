-- Case 22708 - process Cat 376 deceased files from Dingley
    -- code copied from 22515
/*
...
-- DROP TABLE PJC_22708_DeceasedCat376_FD05142014
select count(ixCustomer) CustCnt, 
    count(distinct ixCustomer) DstnctCustCnt
from PJC_22708_DeceasedCat376_FD05142014
...
from  PJC_22708_DeceasedCat376_FD05142014 DC
...
select O.ixCustomer, max(O.dtOrderDate) LastOrd
    from [SMI Reporting].dbo.tblOrder O
    join PJC_22708_DeceasedCat376_FD05142014 DC on O.ixCustomer = DC.ixCustomer
