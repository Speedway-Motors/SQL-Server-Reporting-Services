 /* Case 25934 - Loyalty Builders Data Set 01-01-09 thru 04-09-15 */
...
-- vwLBSampleTransactions (now contains data from 1/1/2009 to YESTERDAY)
    ...
    select COUNT(*) from vwLBSampleTransactions -- 6.2M

    select count(distinct itemid) from vwLBSampleTransactions -- 59K
...
FILE #1 - transaction file data 
    file name: SMI - Transactions 01012009 to 04092015
...
/****************************************************  
FILE #2 - SKU file 
    file name: SMI - SKUs 01012009 to 04092015
...
FILE #3 - PRODUCTS w/ advanced market info 
    file name: SMI - SKU - Additional Markets File 01012009 to 04092015
    records:   165K - 176K
    runtime:   20-30 sec
 ****************************************************/
    -- STEP 1 of 3
    ...
    -- STEP 3 of 3  create output for LB file               
            select -- 182,128    previously 175,973 records  @20 secs
...
FILE #4 - CUSTOMER file 
    file name:   SMI - Customers 01012009 to 04092015
    records:     570-572K     previously 457K - 472K
    runtime:     20-40 sec  
 ****************************************************/
...
FILE #5 - catalogs mailed to each cust & the corresponding type of catalog 
    file name:          SMI - Customer - Catalogs Mailed File 01012009 to 04092015
    approx storage(MB): 211 - 260
    approx records:    11.5M-11.9M        previously 7.6M - 9.5M
    approx runtime:     3:06-3:46         previously 1 - 3 mins
****************************************************/
    select -- 11,876,537  records   
...
FILE #6 - SKUs & applications 
    ...
    file name:          SMI - SKUs and Applications 01012009 to 04092015.txt
...
FILE #7 - Merged Customers
    ...
    file name:          SMI - Merged Customers 01012009 to 04092015.txt
    approx storage(MB):
...
****************************************************/
    -- PREP
        ...
        -- PJC_MergedCustomers
        SELECT * INTO [SMITemp].dbo.PJC_MergedCustomers_BU04102015 -- 36,833
    ...
    Select M.ixCustomerOriginal as 'OrigCustid',    -- 36,836
...
==  ===========     =========   =================================================================   ====    ======  ====
1       6.2M         255-258    SMI - Transactions 01-01-2009 to <YESTERDAY>.txt                    Y       Y       Y
2       59K          8.6-8.7    SMI - SKUs 01-01-2009 to <YESTERDAY>.txt                            Y       Y       Y
3   179K-182K            3.9    SMI - SKU - Additional Markets 01-01-2009 to <YESTERDAY>.txt        Y       Y       Y
4   569K-571K      12.6-12.7    SMI - Customers  01-01-2009 to <YESTERDAY>.txt                      Y       Y       Y
5  11.5M-11.9M       321-332    SMI - Customer - Catalogs Mailed 01-01-2009 to <YESTERDAY>.txt      Y       Y       Y      
...
Loyalty Builders team, the latest dataset for Speedway has been uploaded.  The filename is “SMI - dataset 01-01-2009 to 04-09-2015.7z”.   

It consists of the following 7 files appended with the date range used:

    RECORDS     FILENAME 
    =========   =======================                           
#1  6,238,440   SMI - Transactions
#2     59,866   SMI - SKUs
#3    182,128   SMI - SKU - Additional Markets
#4    571,450   SMI - Customers
#5 11,876,537   SMI - Customer - Catalogs Mailed
#6     68,812   SMI - SKUs and Applications
#7     36,836   SMI - Merged Customers

If there are any questions/concerns, email or call me directly ASAP.  Please do not wait until our next scheduled conference call. 
