-- SMIHD-4971 -  Package Level Detail data for Additional USPS Discount
...
where P.ixShipDate between 17624 and 17653 --   69,937      + 2,659 for Afco <--April 2016   
...
from tblPackage P
 left join tblOrder O on P.ixOrder = O.ixOrder                   
    left join tblShipMethod SM on O.iShipMethod = SM.ixShipMethod
where P.ixShipDate between 17624 and 17287 
    and P.flgCanceled = 0    
    and  O.iShipMethod <> 1 
