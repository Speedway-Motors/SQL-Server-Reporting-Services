-- SMIHD-21344 - Data Extract for Zinrelo
--CREATE VIEW [dbo].[vwLBSampleTransactions] as
...
WHERE C.sCustomerType = 'Retail'
 	and O.dtOrderDate between '05/01/2016' and '04/30/2021' -- LAST 5 years
...
-- RETURNS DATA
    SELECT CMM.ixCustomer 'CustomerID', -- 179,846
    ...
    WHERE CMM.flgCanceled = 0
        ...
        and CMM.dtCreateDate between '05/01/2016' and '04/30/2021' -- MAKE SURE THE DATE IN THE QUERY ABOVE IS THE SAME!
        and O.sOrderType='Retail'	
	    and O.sOrderStatus = 'Shipped'
	    and O.sShipToCountry='US'
        and O.ixOrder not like '%-%'
