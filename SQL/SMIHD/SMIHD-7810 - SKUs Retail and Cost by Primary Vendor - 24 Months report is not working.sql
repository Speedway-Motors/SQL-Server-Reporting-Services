-- SMIHD-7810 - SKUs Retail and Cost by Primary Vendor - 24 Months report is not working
  
DECLARE @CPStart DATETIME,  @CPEnd DATETIME,
        @PPStart DATETIME,  @PPEnd DATETIME

SELECT @CPStart = '06/04/2016',  @CPEnd = '06/04/2017',
       @PPStart = '06/03/2015',  @PPEnd = '06/03/2016'
      
SELECT SKU.ixSKU AS SKU -- Our Part Number          -- 313,349
     ...
     , SKU.dWeight 'SKUWeight'
     , SKU.iLength 'SKULength'
     , SKU.iWidth 'SKUWidth'
     , SKU.iHeight 'SKUHeight'         
...
-- and V.ixVendor = '2757' -- TESTING ONLY  vendor has approx 201 SKUs   ran 6-7-17 @6 seconds
  and V.ixVendor not in ('0494','2921','JUNK')

  --and SKU.ixSKU = '7219100'RDER BY V.ixVendor, SKU   
  
  -- select COUNT(*) from tblVendorSKU where ixVendor = '2757'   and iOrdinality = 1
