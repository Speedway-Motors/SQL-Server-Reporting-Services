-- SMIHD-16896 - AFCO 2019 Customer Analysis
...
SELECT O.ixCustomer, C.sCustomerFirstName, C.sCustomerLastName, 
    SUM(OL.mExtendedPrice) 'LA_Sales',
    SUM(OL.mExtendedCost) 'CoGS',
    (SUM(OL.mExtendedPrice)-SUM(OL.mExtendedCost)) 'GMDollars'
...
WHERE O.dtInvoiceDate between '01/01/2019' and '12/31/2019'
   ...
   -- AND S.ixSKU like '52-%' 
   -- AND S.ixPGC like 'K%'
    AND O.ixCustomer NOT IN ('10890','10511','11571','11572','11573','11574','12410','15242','26101','26103','27511','31173','34795','41138','43648','44776','48319','48398','48400','49948','50093','50239','51861','52097','53315','55108','55634','58769','63406','63900','65908','66504','68773') -- SMI & Internal Accounts
    -- AND S.flgActive = 1
...
SELECT * FROM tblCustomer where ixCustomer = '10890'
