-- SMIHD-13747 - add flgHighPriority to tblOrder
...
select * into [SMIArchive].dbo.BU_tblOrder_20190530 from [SMI Reporting].dbo.tblOrder      --   6,522,520
select * into [SMIArchive].dbo.BU_AFCO_tblOrder_20190530 from [AFCOReporting].dbo.tblOrder --     397,764
...
                                          ,112)
                ...
                flgHighPriority = NULL --@flgHighPriority
                where ixOrder = @ixOrder
            END TRY
...
/******    SOP                                                                                         *******/
    ...
    --SMI TEST DATA
        SELECT * from tblOrder where flgHighPriority is NOT NULL
...
/******    dw.speedway2.com                                                                            *******/
    ...
    UPDATE tblOrder set flgHighPriority = 1
    where ixOrder = '8900643'

    select * from tblOrder where dtOrderDate = '04/01/2019'

    select ixOrder, flgHighPriority, dtDateLastSOPUpdate, T.chTime 'TimeLastSOPUpdate'
    from tblOrder O -- 6,522,641
        left join tblTime T on O.ixTimeLastSOPUpdate = T.ixTime
    where ixOrder in ('8112365','8118360','8200765','8335066')
    order by ixOrder
    /*
    ixOrder	flgHighPriority	dtDateLastSOPUpdate	    TimeLastSOPUpdate
    8112365	1	            2019-05-30 00:00:00.000	13:16:41  
    8118360	0	            2019-05-30 00:00:00.000	13:14:44  
    8200765	0	            2019-05-30 00:00:00.000	13:14:53  
    */

    8112365 (1), 8118360 (0) AND 8200765 (null
    ...
    select count(*) from tblOrder where sOrderStatus = 'Open' -- 923
