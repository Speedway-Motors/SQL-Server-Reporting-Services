--  SMIHD-4990 - QC & Load Catalog REVISED mailing lists for 801 Muscle
...
-- import data from the CST output file that is emailed from CST into a table in SMITEMP -- e.g. PJC_SMIHD4990_CustFile_801_REVISED

-- GLOBALLY REPLACE the following:
    /*
        PJC_SMIHD4990_CustFile_801_REVISED_REVISED
        PJC_SMIHD4990_CustOffers_801_REVISED    
        '801%'
        '801'  
        801
    */  
...
801	    '16 LT SUM MUSC	MC	08/15/2016	09/12/2017	268400
*/
...
-- 9 source codes assigned to ixCatalog 801
/*
Source
Code	sDescription
...
-- DROP TABLE [SMITemp].dbo.PJC_SMIHD4990_CustFile_801_REVISED
-- BEFORE CHANGES
Select ixSourceCode, COUNT(*) Qty
from [SMITemp].dbo.PJC_SMIHD4990_CustFile_801_REVISED -- verify counts match provided LOL list
...
80150	232
*/
-- DROP TABLE PJC_SMIHD4990_CustFile_801_REVISED
...
/*********** check for DUPE CUSTOMERS   ***********/
    ...
    FROM [SMITemp].dbo.PJC_SMIHD4990_CustFile_801_REVISED  
    /*      Distinct
    AllCnt	Count	Delta
   234843	234843	0
    */    
...
/*********** 3. Invalid Customer Numbers ***********/
    ...
    SELECT * FROM [SMITemp].dbo.PJC_SMIHD4990_CustFile_801_REVISED
...
/**********  REMOVE customers flagged as competitor,deceased, or "do not mail" ***********/
    ...
    select count(CF.ixCustomer) 'CustCnt',
        ...
        ABS( COUNT(*) - COUNT(DISTINCT ixCustomer)) AS 'Delta' -- should ALWAYS be 0
    from [SMITemp].dbo.PJC_SMIHD4990_CustFile_801_REVISED CF
    /*      Dist
...
*/             
    ...
    from [SMITemp].dbo.PJC_SMIHD4990_CustFile_801_REVISED
    where ixSourceCode <> '80150'
    order by ixSourceCode
    -- save output to .txt file in \\cloak\QOPDL\CST Customer Offer Files naming convention e.g. PJC_SMIHD4990_CustOffers_801_REVISED.txt
...
-- CUSTOMERS THAT HAVE NOT LOADED YET
 ...
 SELECT CST.* 
 FROM PJC_SMIHD4990_CustFile_801_REVISED_FINAL CST --     LOADED
 ...
 SELECT * FROM PJC_SMIHD4990_CustFile_801_REVISED_FINAL CST
...
*/
            ...
            from [SMITemp].dbo.PJC_SMIHD4990_CustFile_801_REVISED CST
