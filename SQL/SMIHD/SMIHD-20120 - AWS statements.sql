-- SMIHD-20120 - AWS statements
-- DW.SPEEDWAY2.COM

SELECT @@SPID as 'Current SPID' -- 93 
...
BEGIN TRANSACTION
GO
ALTER TABLE [SMiReportingRawData].[Transfer].tblOrderLine ADD
    flgUpsell int,
    sSKUNotInOptimalDC varchar(6)

GO
ALTER TABLE [SMiReportingRawData].[Transfer].tblOrderLine SET (LOCK_ESCALATION = TABLE)
GO
COMMIT
