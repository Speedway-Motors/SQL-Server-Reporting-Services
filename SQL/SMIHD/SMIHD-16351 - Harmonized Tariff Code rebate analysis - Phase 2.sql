-- SMIHD-16351 - Harmonized Tariff Code rebate analysis - Phase 2
...
where S.flgDeletedFromSOP = 0
    and V.ixVendor in ('1154','2404','2304','2895','3290','3895','3896','1363','3238','3415','0099')
...
select * from tblVendorSKU where ixSKU = '97415986'
/*
SKU         PV
91635000    2895
9175161     2895
