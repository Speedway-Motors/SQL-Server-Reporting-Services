-- SMIHD-3251 - SKU Inventory for Eagle
/*
...
select S.ixSKU 'SKU', 
    S.sDescription 'SKUDescription', -- 2,214
...
from tblSKU S -- 285,671
    join (-- unique list of SKUs from either location for either bin
     ...
     --       join tblVendorSKU VS ON SL.ixSKU = VS.ixSKU and VS.ixVendor = 1401
          ...
          and (SL.iQAV > 0        -- Mike decided he only wanted to see ones with QAV > 0 or belonging to the vendor below
               OR
