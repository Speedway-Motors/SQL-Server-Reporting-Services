-- SMIHD-6393 - 2016 Annual Tire Sales by SEMA - Accouting NDOR Review
...
where
	O.dtOrderDate between '01/01/2016' and '12/31/2016' -- RUN FOR THE PREVIOUS YEAR
...
select DISTINCT sSEMAPart from tblSKU
where UPPER(sSEMAPart) like '%TIRE%'	-- 213
AND sSEMAPart <> 'Tires'
AND UPPER(sSEMAPart) <> '%PEDAL%'
