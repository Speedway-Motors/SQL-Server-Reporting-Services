...
UPDATE tmp.tmp_pedalpads, AttributeDropdownItem
SET tmp.tmp_pedalpads.ixColor = AttributeDropdownItem.ixAttributeDropdownItemId
WHERE tmp.tmp_pedalpads.sColor = AttributeDropdownItem.sAttributeDropdownItemText
...
UPDATE tmp.tmp_pedalpads, AttributeDropdownItem
SET tmp.tmp_pedalpads.ixSoldinQuantity = AttributeDropdownItem.ixAttributeDropdownItemId
WHERE tmp.tmp_pedalpads.sSoldinQuantity = AttributeDropdownItem.sAttributeDropdownItemText
...
UPDATE tmp.tmp_pedalpads, AttributeDropdownItem
SET tmp.tmp_pedalpads.ixFinish = AttributeDropdownItem.ixAttributeDropdownItemId
WHERE tmp.tmp_pedalpads.sFinish = AttributeDropdownItem.sAttributeDropdownItemText
...
WHERE tngLive.tblskuvariant.ixSOPSKU = '491BAG6143'
