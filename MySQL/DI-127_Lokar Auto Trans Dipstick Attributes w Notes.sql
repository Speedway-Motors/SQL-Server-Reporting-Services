...
WHERE ixTemplateAttributeId = 662; -- Firewall/Bellhousing/Engine Mount 

UPDATE tmp.tmp_dipsticks
SET tmp.tmp_dipsticks.sDipstickMountStyle = 'Firewall Mount' k
WHERE tmp.tmp_dipsticks.sDipstickMountStyle = 'Firewall';
...
WHERE tngLive.tblskuvariant.ixSOPSKU = '491XTD345RFEFM';